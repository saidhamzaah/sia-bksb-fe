                ...
                <div className="form-group">
                  <div className="title-mobile">
                    ...
                    <div className="helper-text d-sm-none">
                      Login to your existing account to access all the features
                      in Zwallet.
                    </div>
                  </div>
                  ...
                  <div className="form-group password col-lg-8">
                    <input
                      ...
                      style={this.state.passClick}
                      className="form-control border-top-0 border-left-0 border-right-0 rounded-0 "
                      onClick={() => this.uiPassword()}
                  ...
                  <div className="form-button col-lg-8">
                    {this.state.error && (
                      <span
                        className="text-center d-block error-logic"
                        style={{
                          color: "#FF5B37",
                          fontSize: 18,
                          fontWeight: 600,
